...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.MaskDINO.CLASS_WEIGHT = 1.0
    cfg.MODEL.MaskDINO.DICE_WEIGHT = 1.0
    cfg.MODEL.MaskDINO.MASK_WEIGHT = 20.0
    ...
    cfg.MODEL.MaskDINO.TRANSFORMER_IN_FEATURE = "res5"
    ...
    cfg.MODEL.SEM_SEG_HEAD.FEATURE_ORDER = 'high2low'
