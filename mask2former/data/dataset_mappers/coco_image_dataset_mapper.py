...
def build_strong_augmentation(is_train=True):
    ...
    if is_train:
        ...
        augmentation.append(
            transforms.RandomApply([transforms.ColorJitter(0.4, 0.4, 0.4, 0.1)], p=0.0)
        )
        augmentation.append(transforms.RandomGrayscale(p=0.2))
        augmentation.append(transforms.RandomApply([GaussianBlur([0.1, 2.0])], p=0.0))
        ...
        # augmentation.append(T.Resize((image_size, image_size)))
    # augmentation = [T.Resize((image_size, image_size))]
    logger.info("Strong Augmentations used in training: " + str(augmentation))
