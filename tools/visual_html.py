...
def main(list_info,html_page,root_dir,image_file):
    ...
    #for line in str:
        ...
        print(image_display)
        image_display_ufo = os.path.join('visual_maskrcnn', line.strip())
        image_display_ufo1 = os.path.join('visual_mpformer', line.strip())
        image_display_ufo2 = os.path.join('visual_mask2former', line.strip())
        image_display_ufo3 = os.path.join('visual_maskdino', line.strip())
        image_display_ufo4 = os.path.join('visual_gem', line.strip())
        image_display_ufo5 = os.path.join('visual_semitnet', line.strip())
