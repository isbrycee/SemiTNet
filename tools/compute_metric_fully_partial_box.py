...
if __name__ == '__main__':
    gt_json = '/root/paddlejob/workspace/env_run/output/haojing/GuidedDistillation-main-bak-0613/datasets/tooth-x-ray-instance-segmentation-1.6k/tooth_IS_test.json'
    results_json = 'coco_instances_results_box_MPFormer.json'
