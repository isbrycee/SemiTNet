...
def setup(args):
    ...
    # set by handdle for debug; add by hj
    ###########################################
    # 1st
    cfg.SSL.PERCENTAGE = 10
    # cfg.SSL.TRAIN_SSL = False
    cfg.SSL.EVAL_WHO = 'Teacher'
    cfg.MODEL.WEIGHTS = "/root/paddlejob/workspace/env_run/output/haojing/SemiTNet/pretrained_model/SemiTNet_best_box_ap50_convert.pth"
    # 2nd 
    # cfg.SSL.PERCENTAGE = 10
    # cfg.SSL.TRAIN_SSL = True 
    # cfg.SSL.TEACHER_CKPT = '/root/paddlejob/workspace/env_run/output/haojing/GuidedDistillation-main/output/train_1st_teacher/model_best.pth' 
    # cfg.OUTPUT_DIR = '/root/paddlejob/workspace/env_run/output/haojing/GuidedDistillation-main/output/train_2st_student/' 
    # cfg.SSL.BURNIN_ITER = 3000 
    # cfg.SSL.EVAL_WHO = 'BOTH'
    ###########################################
...
def parse_ckpt(ckpt_dir):
    if ckpt_dir.startswith('detectron2://'):
        return 'STUDENT'
    if ckpt_dir.startswith('model_gem_ap94_convert.pth'):
        return 'STUDENT'
